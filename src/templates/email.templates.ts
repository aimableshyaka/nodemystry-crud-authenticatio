  ...
  return `
    ...
    <body>
      <div class="container">
       ...
       Please Login Get Started</a>
        </div>
        <div class="footer">
          <p>© 2026 klabs shop. All rights reserved.</p>
...
export const passwordResetTemplate = (firstName: string, resetToken: string) => {
  const resetUrl = `https://nodemystry-crud-authenticatio.onrender.com/api-docs/#/auth/post_api_auth_reset_password__token_=${resetToken}`;
